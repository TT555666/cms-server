...
var NodeAuth = /** @class */ (function () {
     ...
     */
    NodeAuth.prototype.makePassword = function (password) {
        // 1.生成随机数
     ...
     */
    NodeAuth.prototype.checkPassword = function (password, sqlPwd) {
        // 1.从查询出来的密码中截取前面随机数
    ...
    NodeAuth.prototype.md5MakePassword = function (base64RandomStr, password) {
        // 2.将密码与加密的随机数拼接
