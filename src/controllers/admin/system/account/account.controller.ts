...
export class AccountController {
  ...
  @ApiOperation({ summary: '删除账号', description: '输入账号及密码' })
  @Delete(':id')
  @HttpCode(HttpStatus.CREATED)
  ...
  @Get(':id')
  @HttpCode(HttpStatus.OK)
  async findById(@Param('id', new ParseIntPipe()) id: number): Promise<any> {
  ...
  @Get()
  @HttpCode(HttpStatus.OK)
  async accountList(@Query() queryOption: ObjectType): Promise<any> {
