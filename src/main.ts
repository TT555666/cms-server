...
async function bootstrap() {
  ...
  app.use(
    session({
      secret: process.env.SESSION_SECRET, // 对session id 相关的cookie 进行签名
      resave: true,
  ...
  // mongoose.connect('mongodb://localhost/cms-nestjs-mongodb', {
  ...
  await app.listen(PORT, () => {
    Logger.log(`服务器启动成功请访问:http://localhost:${PORT}/${PREFIX}/docs`);
  });
}
bootstrap();
